...
/**
 * @author: action
 * @create: 2025/12/4 10:30
 *
 * 测试问题：A{
 *     1.我想预约明天上午的神经内科
 *     2.我叫行动，身份证号 370481000000000000，预约张医生
 *     3.请帮我预约明天上午的神经内科，我叫行动，身份证号 370481000000000000，预约张医生
 *     4.对不起，我临时有事，请帮我取消明天的预约
 * }
 *
 *  测试问题（实现rag后）：B{
 *       1.我头疼应该怎么处理
 *       2.我叫行动，身份证号 370481000000000000，想预约 明天下午神经内科最好的医生
 *       ###3.确认
 *       4.医院的位置在哪，神经内科怎么找
 *   }
 *
